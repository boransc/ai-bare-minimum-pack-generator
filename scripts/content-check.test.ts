/**
 * Content fidelity audit: does content/v1 actually say what the source document says?
 *
 ...
 * The source's: the action titles and details on each sub-statement (condensed from
...
describe.skipIf(!sourcePresent)("content fidelity", () => {
  it("every verbatim string appears in the source document", () => {
